	...
	function showTree()
{
	...
	//加入一个节点。
	var treeNode_Data = new WebFXTreeItem("数据仓库模式");
	...
	for(var i=0;i<schemaConfigFileLength;i++)
	{
		...
		//loadSchemaNode()这个函数由shemaName,shemaPath生成树状图，在这里这个图应该作为一个上面树的
		//分支，这个分支包含一个Schema的所有内容；故在设计loadSchemaNode()时让它
		//返回一个WebFXTreeItem节点。
	...
	var treeNode_SystemConfig = new WebFXTreeItem("系统配置"); 
