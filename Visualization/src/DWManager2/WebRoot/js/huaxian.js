...
VMLRenderer.prototype.drawArrow = function(id,left,top,left1,top1,color){
	var line = this.container.ownerDocument.createElement('v:line');
    line.style.position = 'absolute';//absolute
...
FlowGraphic.prototype.drawLine = function(id,x1,y1,x2,y2){
	return this.drawArrow(id,x1,y1,x2,y2);
}