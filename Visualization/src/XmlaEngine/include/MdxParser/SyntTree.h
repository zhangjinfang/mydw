...
enum NodeType  {          
   ...
   MEM_STMT,         /**< 有2个孩子节点,对应"member_specification"规则. */
   ...
   FUN_STMT,        /**< 有2个孩子节点,对应"fun_specification"规则. */
   MEM_EXPR         /**< 有1个孩子节点,对应"member_expression"规则. */
};
...
public:
     ...
     */
    QueryMember* creatQueryMember(XSchema* _sch, vector<string>& _vecmem);
...
//	 * @return ParsedMDX
    ...
    void traverse(vector<string>& _vecMemInfo,
